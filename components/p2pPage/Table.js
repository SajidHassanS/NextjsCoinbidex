  ...
  return (
    <div className="table-container">
      <table className="table-fixed w-full ">
        <thead>
          <tr>
            <th className="w-1/5 text-left border-t border-b border-white-300">Advertiser</th>
            <th className="w-1/5 text-left border-t border-b border-white-300">Price</th>
            <th className="w-2/5 text-left border-t border-b border-white-300">Available | Limits</th>
            <th className="w-1/5 text-left border-t border-b border-white-300">Payment Method</th>
            <th className="w-1/5 text-left border-t border-b border-white-300">
...
const TableData = ({ advertiserName, price, available, limits, paymentMethod, eligible }) => {
  return (
    <tr className="tableRow">
      <td className="w-1/5py-2">
        <div className="flex items-center">
          <div className="flex-shrink-0 h-8 w-8">
            <GoDotFill size={20} className="dot-icon" />
          </div>
          <div className="ml-3">
      ...
      <td className="w-1/5 py-2">
        <div className="flex items-center">
          ...
          <FaInfoCircle className="info-icon hidden sm:block ml-2 text-black-500" />
